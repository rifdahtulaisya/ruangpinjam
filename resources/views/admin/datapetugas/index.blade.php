        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
              ...
              w-full sm:w-auto">
                    ...
                    <span class="text-sm sm:text-base">Tambah Petugas</span>
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow p-4 mb-6">
        <div class="flex flex-col md:flex-row gap-4 items-center justify-between">
            ...
            <div class="w-full md:w-auto">
                <form id="searchForm" method="GET" action="{{ route('admin.datapetugas.index') }}"
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="flex bg-slate-100 rounded-lg p-1">
                    @foreach ([5, 10, 15, 20] as $perPage)
                        <a href="{{ route('admin.datapetugas.index', array_merge(request()->except('page'), ['per_page' => $perPage])) }}"
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-8 text-center text-slate-500">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-slate-500">Tidak ada data petugas</p>
