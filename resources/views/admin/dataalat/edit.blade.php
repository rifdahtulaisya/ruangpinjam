                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="flex items-center gap-6">
                            ...
                            <div id="previewContainer"
                                ...
                                @if ($dataalat->has_foto)
                                    <img id="fotoPreview" src="{{ $dataalat->foto_url }}" alt="{{ $dataalat->nama_alat }}"
                                        class="w-full h-full object-cover">
                                @else
                                    <div id="noFotoPreview"
                            ...
                            <div class="flex-1 space-y-4">
                               ...
                               hover:bg-blue-600 transition flex items-center gap-2">
                                    ...
                                    @if ($dataalat->has_foto)
                                        <button type="button" onclick="confirmRemoveFoto()"
                               ...
                               hover:bg-red-600 transition flex items-center gap-2">
                                        ...
                                        <input type="checkbox" name="hapus_foto" id="hapus_foto" class="hidden"
                                            value="1">
                                    @endif
                                </div>
                    ...
                    <div>
                        ...
                        <select name="kondisi" required
                            class="w-full px-4 py-2.5 border border-slate-300 rounded-lg
                                   focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            <option value="baik" {{ old('kondisi', $dataalat->kondisi) == 'baik' ? 'selected' : '' }}>
                                Baik</option>
                            <option value="rusak_ringan"
                                {{ old('kondisi', $dataalat->kondisi) == 'rusak_ringan' ? 'selected' : '' }}>Rusak Ringan
                            </option>
                            <option value="rusak_berat"
                                {{ old('kondisi', $dataalat->kondisi) == 'rusak_berat' ? 'selected' : '' }}>Rusak Berat
                            </option>
                            <option value="perlu_perbaikan"
                                {{ old('kondisi', $dataalat->kondisi) == 'perlu_perbaikan' ? 'selected' : '' }}>Perlu
                                Perbaikan</option>
                        </select>
                        @error('kondisi')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <input type="number" name="stok" value="{{ old('stok', $dataalat->stok) }}" required
                            min="0"
                            class="w-full px-4 py-2.5 border border-slate-300 rounded-lg
                                  focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            placeholder="0">
