    ...
    <div class="bg-white rounded-xl shadow p-4 mb-6">
        <div class="flex flex-col md:flex-row gap-4 items-center justify-between">
            ...
            <div class="w-full md:w-auto">
                <form id="searchForm" method="GET" action="{{ route('admin.dataalat.index') }}"
                        ...
                        <tr class="hover:bg-slate-50 transition">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex justify-center gap-2">
                                    ...
                                    <!-- Delete Button -->
                                    <form action="{{ route('admin.dataalat.destroy', $item->id) }}" method="POST"
                        ...
                        <tr>
                            <td colspan="7" class="px-6 py-8 text-center text-slate-500">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-slate-500">Tidak ada data alat</p>
        ...
        document.querySelectorAll('.delete-form').forEach(form => {
            form.addEventListener('submit', function(e) {
                ...
                Swal.fire({
                    ...
                    text: "Data alat akan dihapus permanen!",
                    icon: 'warning',
