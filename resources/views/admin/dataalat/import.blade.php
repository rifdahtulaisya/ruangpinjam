        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-emerald-500 to-emerald-600 px-6 py-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-white">Import Data Alat</h2>
                        <p class="text-emerald-100 text-sm">Import data alat dari file Excel/CSV</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="text-sm text-blue-700">
                            ...
                            <ul class="list-disc list-inside space-y-1">
                                ...
                                <li>Kolom yang wajib diisi: nama_alat, kategori, kondisi, stok</li>
                                <li>Kondisi harus salah satu: baik, rusak_ringan, rusak_berat, perlu_perbaikan</li>
                                <li>Nama kategori harus sesuai dengan data kategori yang sudah ada</li>
                                <li>Jika nama alat sudah ada, stok akan ditambahkan</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-6 p-4 bg-gray-50 rounded-lg">
                    <div class="flex items-center justify-between flex-wrap gap-3">
                        ...
                        <a href="{{ route('admin.dataalat.import.template') }}" 
                ...
                <!-- Form Import -->
                <form action="{{ route('admin.dataalat.import.process') }}" method="POST" enctype="multipart/form-data" id="importForm">
                    @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-emerald-500 transition" id="dropzone">
                            <div class="space-y-1 text-center">
                                <i class="fa-solid fa-cloud-upload-alt text-4xl text-gray-400"></i>
                                <div class="flex text-sm text-gray-600">
                                    <label for="file" class="relative cursor-pointer bg-white rounded-md font-medium text-emerald-600 hover:text-emerald-500 focus-within:outline-none">
                        ...
                        <div id="fileNameDisplay" class="mt-2 text-sm text-gray-600 hidden">
                            <i class="fa-solid fa-file text-emerald-500"></i>
                    ...
                    <div class="flex gap-3 justify-end">
                        ...
                        <button type="submit" 
                                class="px-6 py-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg transition flex items-center gap-2" 
                                id="submitBtn">
