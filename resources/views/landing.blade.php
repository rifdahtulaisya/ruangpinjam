...
<body class="school-bg">
        ...
        <nav class="container mx-auto px-4 sm:px-6 py-4">
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center">
                    <div
                        class="w-10 h-10 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl 
               bg-gradient-to-r from-blue-600 to-teal-500 
               flex items-center justify-center shadow-md overflow-hidden">

                        <!-- GANTI ICON DENGAN FOTO -->
                        <img src="{{ asset('assets-admin/img/2.svg') }}" alt="Logo RuangPinjam"
                            class="w-full h-full object-cover">
                    </div>
                    <div class="ml-3">
                        <span class="text-xl sm:text-2xl font-bold text-darkBlue">Ruang<span
                                class="text-blue-600">Pinjam</span>
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <a href="#home"
                        class="font-medium text-darkBlue hover:text-blue-600 transition-colors">Bantuan</a>
                    <a href="#home" class="font-medium text-darkBlue hover:text-blue-600 transition-colors">Tentang
                        kami</a>
    ...
    <img src="{{ asset('assets-admin/img/2.svg') }}" 
        ...
        <div class="sidebar-cta">
            ...
            @auth
                <a href="{{ url(auth()->user()->role . '/dashboard') }}" class="sidebar-cta-button bg-green-600">
                    Dashboard
                </a>
            @endauth
        ...
        <div class="container mx-auto px-4 sm:px-6">
            <div class="flex flex-col md:flex-row items-center">
                ...
                <div class="md:w-1/2 mb-10 md:mb-0 animate-slide-in hero-content">
                    <div
                        class="inline-flex items-center bg-white/20 backdrop-blur-sm rounded-full px-3 py-1.5 sm:px-4 sm:py-2 mb-4 sm:mb-6 text-sm">
                    ...
                    <p class="text-base sm:text-lg mb-6 sm:mb-8 text-white/90">
                        Kelola peminjaman peralatan sekolah, laboratorium, olahraga, dan multimedia dengan sistem
                        digital yang modern dan efisien.
                    </p>
                    <div class="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
    <a href="{{ route('login') }}" class="btn-primary text-base sm:text-lg inline-flex items-center">
        ...
        Mulai Pinjam
                ...
                <div class="md:w-1/2 flex justify-center animate-float mt-8 md:mt-0">
                    <div class="relative">
                        <div
                            class="w-64 h-64 sm:w-72 sm:h-72 md:w-80 md:h-80 bg-gradient-to-br from-blue-600/20 to-teal-500/20 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-2xl">
                            <div
                                class="w-52 h-52 sm:w-56 sm:h-56 md:w-64 md:h-64 bg-gradient-to-tr from-blue-500/30 to-teal-400/30 rounded-xl sm:rounded-2xl flex items-center justify-center">
                                <div
                                    class="w-40 h-40 sm:w-44 sm:h-44 md:w-48 md:h-48 bg-white/10 rounded-xl sm:rounded-2xl flex items-center justify-center backdrop-blur-sm border border-white/20">
                        ...
                        <!-- Floating elements -->
                        <div
                            class="absolute -top-2 -left-2 sm:-top-4 sm:-left-4 w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 bg-orange-500 rounded-lg sm:rounded-2xl flex items-center justify-center shadow-lg">
                            <i class="fas fa-basketball-ball text-white text-lg sm:text-2xl md:text-3xl"></i>
                        </div>
                        <div
                            class="absolute -bottom-2 -right-2 sm:-bottom-4 sm:-right-4 w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 bg-white rounded-lg sm:rounded-2xl flex items-center justify-center shadow-lg">
                            <i class="fas fa-microscope text-blue-600 text-xl sm:text-3xl md:text-4xl"></i>
                        </div>
                        <div
                            class="absolute top-8 -right-4 sm:top-10 sm:-right-8 w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-purple-500 rounded-lg sm:rounded-2xl flex items-center justify-center shadow-lg">
    ...
    <section id="process" class="py-12 sm:py-16 bg-gradient-to-b from-slate-50 to-white">
        <div class="container mx-auto px-4 sm:px-6">
            ...
            <div class="relative">
                ...
                <div
                    class="hidden md:block absolute top-1/2 left-0 right-0 h-2 bg-gradient-to-r from-blue-500 via-teal-500 to-orange-500 transform -translate-y-1/2 rounded-full">
                </div>

                <div class="grid grid-cols-1 md:grid-cols-4 gap-6 sm:gap-8 md:gap-4 relative">
                    <!-- Step 1 -->
                    <div
                        class="bg-white p-6 sm:p-8 rounded-xl sm:rounded-2xl shadow-lg text-center z-10 border border-slate-200 process-step">
                        <div
                            class="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-r from-blue-600 to-blue-400 text-white rounded-full flex items-center justify-center text-xl sm:text-2xl font-bold mx-auto mb-4 sm:mb-6 shadow-md">
                            <i class="fas fa-search"></i>
                        </div>
                        <h3 class="text-lg sm:text-xl font-bold text-darkBlue mb-3 sm:mb-4">Cari Alat/Barang</h3>
                        <p class="text-sm sm:text-base text-gray-600">
                            Cari barang yang dibutuhkan melalui Daftar.
                        </p>
                    </div>
                    ...
                    <div
                        class="bg-white p-6 sm:p-8 rounded-xl sm:rounded-2xl shadow-lg text-center z-10 border border-slate-200 process-step">
                        <div
                            class="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-r from-teal-600 to-teal-400 text-white rounded-full flex items-center justify-center text-xl sm:text-2xl font-bold mx-auto mb-4 sm:mb-6 shadow-md">
                            <i class="fas fa-calendar-alt"></i>
                        </div>
                        <h3 class="text-lg sm:text-xl font-bold text-darkBlue mb-3 sm:mb-4">Atur Jadwal</h3>
                        <p class="text-sm sm:text-base text-gray-600">
                            Pilih tanggal pengembalian di Formulir Peminjaman.
                        </p>
                    </div>
                    ...
                    <div
                        class="bg-white p-6 sm:p-8 rounded-xl sm:rounded-2xl shadow-lg text-center z-10 border border-slate-200 process-step">
                        <div
                            class="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-r from-orange-600 to-orange-400 text-white rounded-full flex items-center justify-center text-xl sm:text-2xl font-bold mx-auto mb-4 sm:mb-6 shadow-md">
                            <i class="fas fa-check-circle"></i>
                        </div>
                        <h3 class="text-lg sm:text-xl font-bold text-darkBlue mb-3 sm:mb-4">Konfirmasi</h3>
                        <p class="text-sm sm:text-base text-gray-600">
                            Tunggu konfirmasi dari Petuga.
                        </p>
                    </div>
                    ...
                    <div
                        class="bg-white p-6 sm:p-8 rounded-xl sm:rounded-2xl shadow-lg text-center z-10 border border-slate-200 process-step">
                        <div
                            class="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-r from-purple-600 to-purple-400 text-white rounded-full flex items-center justify-center text-xl sm:text-2xl font-bold mx-auto mb-4 sm:mb-6 shadow-md">
    ...
    <img src="{{ asset('assets-admin/img/2.svg') }}"
         ...
         class="w-full h-full object-cover">
                        ...
                        <div class="ml-3">
                            <span class="text-xl sm:text-2xl font-bold">Ruang<span class="text-blue-400">Pinjam</span>
                                <p class="text-xs text-gray-300 -mt-1 hidden sm:block">Sistem Peminjaman Barang Sekolah
                                </p>
                        </div>
                    </div>
                    ...
                    <div class="flex space-x-3 sm:space-x-4">
                        <a href="#"
                            class="w-8 h-8 sm:w-10 sm:h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-blue-500 transition-colors">
                            <i class="fab fa-facebook-f text-sm"></i>
                        </a>
                        <a href="#"
                            class="w-8 h-8 sm:w-10 sm:h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-blue-400 transition-colors">
                            <i class="fab fa-twitter text-sm"></i>
                        </a>
                        <a href="#"
                            class="w-8 h-8 sm:w-10 sm:h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-pink-600 transition-colors">
                            <i class="fab fa-instagram text-sm"></i>
                        </a>
                        <a href="#"
                            class="w-8 h-8 sm:w-10 sm:h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-blue-700 transition-colors">
                ...
                <div>
                    ...
                    <ul class="space-y-2 sm:space-y-3">
                        <li><a href="#home"
                                class="text-white/80 hover:text-blue-300 transition-colors text-sm sm:text-base">Beranda</a>
                        </li>
                ...
                <div>
                    ...
                    <ul class="space-y-2 sm:space-y-3">
                        <li><a href="#"
                                class="text-white/80 hover:text-blue-300 transition-colors text-sm sm:text-base">Kebersihaan</a>
                        </li>
                        <li><a href="#"
                                class="text-white/80 hover:text-blue-300 transition-colors text-sm sm:text-base">Olahraga</a>
                        </li>
                        <li><a href="#"
                                class="text-white/80 hover:text-blue-300 transition-colors text-sm sm:text-base">Multimedia</a>
                        </li>
                        <li><a href="#"
                                class="text-white/80 hover:text-blue-300 transition-colors text-sm sm:text-base">Perpustakaan</a>
                        </li>
                        <li><a href="#"
                                class="text-white/80 hover:text-blue-300 transition-colors text-sm sm:text-base">Kesenian</a>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3 sm:space-y-4">
                        <li class="flex items-start">
                            ...
                            <span class="text-white/80 text-sm sm:text-base">Jl. Pendidikan No. 123, Jakarta
                                Selatan</span>
                        </li>
            ...
            <div class="border-t border-white/20 pt-6 sm:pt-8 text-center">
                <p class="text-white/70 text-sm sm:text-base">&copy; <span id="current-year">2023</span>
                    RuangPinjam. Hak cipta dilindungi undang-undang.</p>
                <p class="text-white/50 text-xs sm:text-sm mt-1 sm:mt-2">Dikembangkan untuk mendukung pendidikan
