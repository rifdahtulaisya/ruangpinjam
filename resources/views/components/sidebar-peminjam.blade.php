...
<aside id="sidebar"
    class="fixed left-0 top-0 w-[300px] h-screen
           bg-gradient-to-b from-blue-50 to-sky-50
    ...
    <div class="px-8 py-8">
        ...
        <!-- GARIS -->
        <div class="mt-8 border-b border-blue-200"></div>
    </div>
    <!-- MENU -->
    <nav class="px-6 text-sm space-y-2 flex-1 overflow-y-auto">
      <!-- DASHBOARD -->
        ...
        {{ Route::is('peminjam.dashboard') 
            ...
            : 'border-r-4 border-transparent hover:bg-blue-100/70' }}">
    ...
    <div class="px-6 pb-6 space-y-3">
        ...
        <a href="{{ route('peminjam.profile.index') }}" 
           class="block bg-white/80 backdrop-blur-sm rounded-xl p-4 border border-blue-200 shadow-sm 
                  hover:bg-blue-50/80 hover:border-blue-300 hover:shadow-md
                  transition-all duration-200 group">
            <div class="flex items-center gap-3">
                <!-- Avatar dengan badge role -->
                <div class="relative">
                    <img src="{{ asset('assets-admin/img/2.svg') }}" 
                         class="w-12 h-12 rounded-full object-cover border-2 border-blue-400 group-hover:border-blue-500 transition-all"
                         alt="User Avatar">
                    <span class="absolute -bottom-1 -right-1 w-4 h-4 bg-blue-500 border-2 border-white rounded-full"></span>
                </div>
                
                <!-- Info User -->
                <div class="flex-1 min-w-0">
                    <div class="flex items-center justify-between">
                        <p class="text-sm font-semibold text-slate-800 truncate group-hover:text-blue-700">
                            {{ Auth::user()->name ?? 'Peminjam' }}
                        </p>
                        <i class="fa-solid fa-chevron-right text-blue-400 text-xs opacity-0 group-hover:opacity-100 transition-opacity"></i>
                    </div>
                    ...
                    <div class="flex items-center gap-1 mt-1">
                        <span class="px-2 py-0.5 bg-blue-100 text-blue-700 rounded-full text-[10px] font-medium group-hover:bg-blue-200">
            ...
            <div class="text-[10px] text-blue-500 text-right mt-1 opacity-0 group-hover:opacity-100 transition-opacity">
