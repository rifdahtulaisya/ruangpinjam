...
<div class="space-y-8 animate-slide-in">
    ...
    <div class="bg-white rounded-2xl shadow-lg p-6">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-2xl font-bold text-slate-800">Profil Peminjam</h2>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6">
                ...
                <form action="{{ route('peminjam.profile.update') }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6">
                ...
                <form action="{{ route('peminjam.profile.change-password') }}" method="POST" class="space-y-6">
                    @csrf
