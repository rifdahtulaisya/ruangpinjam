...
class PeminjamImport implements ToModel, WithHeadingRow, WithValidation, SkipsOnFailure
{
    use SkipsFailures;
    ...
    public function model(array $row)
    {
        ...
        if ($existingUser) {
            ...
            $existingUser->update([
                ...
                'kelas_jurusan' => $row['kelas_jurusan'] ?? null,
    ...
    public function rules(): array
    {
        return [
            ...
            '*.kelas_jurusan' => 'nullable|string|max:50',
    ...
    public function customValidationMessages()
    {
        return [
            ...
            'kelas_jurusan.max' => 'Kelas/jurusan maksimal 50 karakter',
